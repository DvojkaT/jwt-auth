...
Copy the `config` file from `vendor/ifs/jwt-auth/config/config.php` to `config` folder of your Lumen application and rename it to `jwt.php`
...
// Add this line
$app->register(ifs\JWTAuth\Providers\LumenServiceProvider::class);
```
