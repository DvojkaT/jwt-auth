...
use ifs\JWTAuth\Validators\TokenValidator;

class TokenValidatorTest extends AbstractTestCase
{
    /**
     * @var \ifs\JWTAuth\Validators\TokenValidator
     */
    protected $validator;
     ...
     * @test
     *
     * @dataProvider \ifs\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderMalformedTokens
     *
     * @param  string  $token
     */
     ...
     * @test
     *
     * @dataProvider \ifs\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderTokensWithWrongSegmentsNumber
     */
