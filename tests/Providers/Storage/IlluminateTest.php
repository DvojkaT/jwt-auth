...
class IlluminateTest extends AbstractTestCase
{
    ...
    /**
     * @var \ifs\JWTAuth\Providers\Storage\Illuminate
     */
    protected $storage;
    ...
    private function emulateTags()
    {
        ...
        $this->cache->shouldReceive('tags')->with('ifs.jwt')->once()->andReturn(Mockery::self());
    }
